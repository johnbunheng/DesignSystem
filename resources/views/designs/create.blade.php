...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Add New Design</h1>
        ...
        <form action="{{ route('designs.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="order_by" id="order_by" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="more" id="more" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Extra notes or report details"></textarea>
            </div>
